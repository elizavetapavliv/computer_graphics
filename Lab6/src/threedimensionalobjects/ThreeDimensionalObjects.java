...
import static threedimensionalobjects.MatrixOperations.multiplyVectorMatrix;

public class ThreeDimensionalObjects extends Application {
    ...
    private void buildAxesAndGrid() {
        ...
        for (int i = -n / 2; i <= n / 2; i++) {
            ...
            Box x = createBox(fullLength, thickness, thickness, Color.ANTIQUEWHITE);
            ...
            Box y = createBox(thickness, fullLength, thickness, Color.ANTIQUEWHITE);
            ...
            Box z = createBox(thickness, thickness, fullLength, Color.ANTIQUEWHITE);
    ...
    private void addButtonsToStage(Stage stage, Group root){
        Button transformateButton = createButton("Transformate", 100);
        transformateButton.setOnAction((final ActionEvent e) -> {
            loadInputWindow(stage);
        });
        Button xyButton = createButton("Oxy projection", 200);
        xyButton.setOnAction((final ActionEvent e) -> {
            if(xyProjection == null){
                buildProjection(1, 1, 0, Color.MINTCREAM, 1);
            }
            else {
        ...
        Button xzButton = createButton("Oxz projection", 300);
        xzButton.setOnAction((final ActionEvent e) -> {
            if (xzProjection == null) {
                buildProjection(1, 0, 1, Color.MISTYROSE, 2);
            } 
            else {
        ...
        Button yzButton = createButton("Oyz projection", 400);
        yzButton.setOnAction((final ActionEvent e) -> {
            if (yzProjection == null) {
                buildProjection(0, 1, 1, Color.ALICEBLUE, 3);
            } 
            else {
    ...
    public void start(Stage stage) throws Exception {
        ...
        stage.setTitle("Three dimensional objects");
        stage.show();
    }
